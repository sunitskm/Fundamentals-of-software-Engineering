...
public class queryusers{
    ...
    public String dbData(String firstName, String lastName, String ssn, String zipcode){
        ...
        try{
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/election_management?useSSL=false","root","root");//connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/election_management","demo","demo");
