...
public class queryusersmanager{
    ...
    public String dbData(String firstName, String lastName, String ssn, String zipcode){
        ...
        try{
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/election_management","demo","demo");//connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/election_management","demo","demo");
